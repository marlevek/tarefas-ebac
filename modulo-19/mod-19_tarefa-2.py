...
# ajustar tema do seaborn para melhor visualização dos gráficos
set_theme =  {"axes.spines.right": False, "axes.spines.top": False}
sns.set_theme(style="ticks", rc=set_theme)
