...
sns.set_theme(context='talk', style='ticks', palette='rainbow')
...
st.markdown('<h1 style="text-align:center;">Análise exploratória da previsão de renda</h1>', unsafe_allow_html=True)

renda = pd.read_csv('./input/previsao_de_renda.csv')

#plots
fig, ax = plt.subplots(8,1,figsize=(10,90))
renda[['posse_de_imovel','renda']].plot(kind='hist', ax=ax[0])
st.subheader('1. Gráficos ao longo do tempo')
...
st.subheader('2. Gráficos bivariada')
